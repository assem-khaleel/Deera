...
INSERT INTO `cart` (`id`, `users_id`, `shop_id`, `coffee_id`, `order_id`, `deliver_charge`, `quantity`, `unit_price`, `total_price`, `special_request`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `coffee` (`id`, `name_en`, `name_ar`, `shop_id`, `cuisine_id`, `menu_section_id`, `category_id`, `delivery_menu_id`, `parent_id`, `price`, `quantity`, `img`, `discount`, `available_from`, `available_to`, `description_en`, `description_ar`, `status`, `created_at`, `updated_at`) VALUES
(3, 'coffee 1', 'الطبق 1', 4, 1, 1, 3, 1, 1, '13', 0, '/assets/website/images/coffeees/coffeees1.jpg', '', '2016-06-06', '2019-06-18', 'coffee 1 description', 'شرح الطبق 1', 0, '2017-05-20 14:06:58', '2017-06-07 20:12:47'),
...
(6, 'supper  sobrem ', 'سوير سوبريم كبير ', 5, 1, 1, 3, 1, 0, '3,650', 74, '/files/3856_31241coffeees3.jpg', '100', '2016-06-07', '2018-06-07', 'sober sobrem ', 'سوير سوبريم كبير ', 0, '2017-06-07 19:00:58', '2017-06-07 21:24:37'),
...
(9, 'mak roial', 'ماك رويال', 6, 1, 1, 3, 1, 0, '2.555', 1, '/files/13082_24139coffeees6.jpg', '150', '2016-06-07', '2018-06-07', 'mak roial', 'ماك رويال', 0, '2017-06-07 19:14:46', '2017-06-07 19:32:09'),
(10, 'Falafil', 'فلافل', 7, 1, 1, 3, 1, 0, '4', 75, '/files/3856_31241coffeees3.jpg', '1', '2016-06-07', '2018-06-07', 'falafil', 'فلافل', 0, '2017-06-07 21:14:21', '2017-06-08 09:52:40'),
...
(2, 82, 3, 3, 'coffee rate description', 1, 1, '1', '2017-06-03 00:45:14');
...
(4, 'MCDonald', 'ماك', 'taylor', 'successor', 'taylorsuccessor@gmail.com', 'knet,visa, cash ', '0785181656', 'address shop 1', 'عنوان 1', 'description shop 1', 'شرح المطعم 1', 1, '21.32', '08:00:00', '16:00:00', '09:00:00', '15:00:00', '2.5', 3, 1, 7, 1, 'summary shop 1', 'مختصر المطعم 1', '/assets/website/images/img_order1.jpg', '/files/18952_9633res4.jpg', 1, 1, '10', 3, 0, 1, '35.9754138', '31.9897962', '2017-05-19 14:26:54', '2017-06-07 19:46:54'),
...
(11, 'deeradriver', 'deeradriver', '|*.address.*.*|*.order.*.*|*.order_driver.*.*|*.*.allData.*|dashboard.*.*.*', '|*.*.userData.*', '2017-06-05 15:16:18', '2017-06-05 15:17:30'),
...
--
ALTER TABLE `cart`
  ADD CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`shop_id`) REFERENCES `shop` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
