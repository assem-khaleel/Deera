...
(3, 'coffee 1', 'الطبق 1', 4, 1, 1, 3, 1, 1, '13', 200, '/assets/website/images/coffeees/coffeees1.jpg', '2', '2017-04-01', '2017-07-01', 'coffee 1 description', 'شرح الطبق 1', 0, '2017-05-20 14:06:58', '2017-05-20 14:06:58');
...
INSERT INTO `order` (`id`, `users_id`, `shop_id`, `area_id`, `from_id`, `address_id`, `order_time`, `deliver_time`, `deliver_date`, `note`, `deliver_charge`, `rate`, `point`, `notification`, `status`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `shop` (`id`, `name_en`, `name_ar`, `Owner_first_name`, `Owner_last_name`, `email`, `available_payment`, `telephone`, `address_en`, `address_ar`, `description_en`, `description_ar`, `status`, `min_amount`, `working_hour_from`, `working_hour_to`, `deliver_time_from`, `deliver_time_to`, `deliver_charge`, `rating`, `show_menu`, `order_accept_days`, `offline_order`, `summary_en`, `summary_ar`, `url`, `img`, `commission_type`, `discount_type`, `discount`, `area_id`, `follow_us`, `notification`, `created_at`, `updated_at`) VALUES
...
(4, 'shop 1', 'المطعم 1', 'taylor', 'successor', 'taylorsuccessor@gmail.com', 'knet,visa, cash ', '0785181656', 'address shop 1', 'عنوان 1', 'description shop 1', 'شرح المطعم 1', 0, '21.32', '08:00:00', '16:00:00', '09:00:00', '15:00:00', '2.5', 3, 1, 3, 1, 'summary shop 1', 'مختصر المطعم 1', '/assets/website/images/img_order1.jpg', '/assets/website/images/img_order1.jpg', 1, 0, '10', 3, 0, 1, '2017-05-19 14:26:54', '2017-05-19 14:26:54');
...
--
ALTER TABLE `coffee_rate`
  ADD CONSTRAINT `coffee_rate_ibfk_1` FOREIGN KEY (`shop_id`) REFERENCES `shop` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
