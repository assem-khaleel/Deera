            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('mycp.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('general.editemail_group_users') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
    ...
    {!! Form::model($email_group_users, [
        ...
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{ trans('general.editemail_group_users') }}</span>
            </div>
        ...
        <div class="row">        <div class="form-group {{ $errors->has('group_id') ? 'has-error' : ''}} col-xs-6">
            {!! Form::label('group_id', trans('group_id'), ['class' => 'col-sm-4 control-label']) !!}
            <div class="col-sm-8">
