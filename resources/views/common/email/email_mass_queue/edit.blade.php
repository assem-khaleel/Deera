            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('mycp.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('general.editemail_mass_queue') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
    ...
    {!! Form::model($email_mass_queue, [
        ...
        <div class="panel">
            <div class="panel-heading">
                <span class="panel-title">{{ trans('general.editemail_mass_queue') }}</span>
            </div>
        ...
        <div class="row">        <div class="form-group {{ $errors->has('language') ? 'has-error' : ''}} col-xs-6">
            ...
            {!! Form::label('last_users_id', trans('last_users_id'), ['class' => 'col-sm-4 control-label']) !!}
            <div class="col-sm-8">
