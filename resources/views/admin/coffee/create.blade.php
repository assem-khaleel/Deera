            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('project.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('coffee.coffeeCreate') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="white-box">
                        ...
                        <p class="text-muted m-b-40">{{ trans('coffee.addcoffee') }}</p>
                        <!-- Nav tabs -->
...
$request->merge(['available_from'=>$current_date,'available_to'=>$current_date]);/*--}}
                                {!! Form::model($request,['url' => '/admin/coffee', 'class' => 'form-horizontal']) !!}
...
<div class="col-sm-8">
    ...
    {!! $errors->first("cuisine_id", "<p class='help-block'>:message</p>") !!}
        ...
        <div class="form-group {{ $errors->has("menu_section_id") ? "has-error" : ""}}  col-xs-6" style="">
{!! Form::label("menu_section_id", trans("general.menu_section"), ["class" => "col-sm-4 control-label"]) !!}
<div class="col-sm-8">
    {!! Form::select("menu_section_id",$menuSectionList, (!isset($request->menu_section_id)? 0:null) , ["class" => "form-control","placeholder"=> trans("coffee.menu_section_id")]) !!}
...
{!! Form::label("quantity", 'Max Quantity', ["class" => "col-sm-4 control-label"]) !!}
<div class="col-sm-8">
    {!! Form::text("quantity",  (!isset($request->quantity)? 1000:null) , ["class" => "form-control","placeholder"=> trans("coffee.quantity")]) !!}
