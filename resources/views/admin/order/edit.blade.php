                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group {{ $errors->has("users_id") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::select("users_id",$usersList, null, ["class" => "form-control","placeholder"=> trans("order.users_id") ,'disabled'=>'disabled']) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("shop_id") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::select("shop_id",$shopList, null, ["class" => "form-control","placeholder"=> trans("order.users_id") ,'disabled'=>'disabled']) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("area_id") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::select("area_id",$areaList, null, ["class" => "form-control","placeholder"=> trans("order.area_id"),'disabled'=>'disabled']) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("address_id") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::select("address_id",$addressList, null, ["class" => "form-control","placeholder"=> trans("order.address_id") ,'disabled'=>'disabled']) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("deliver_time") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8  input-group clockpicker " data-placement="bottom" data-align="top" data-autoclose="true">
                                                {!! Form::text("deliver_time", null, ["class" => "form-control","placeholder"=> trans("order.deliver_time") ,'disabled'=>'disabled']) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("deliver_date") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text("deliver_date", null, ["class" => "form-control mydatepicker","placeholder"=> trans("order.deliver_date") ,'disabled'=>'disabled']) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("deliver_charge") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text("deliver_charge", null, ["class" => "form-control","placeholder"=> trans("order.deliver_charge") ,'disabled'=>'disabled']) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("deera_charge") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text("deera_charge", null, ["class" => "form-control","placeholder"=> trans("order.deera_charge") ,'disabled'=>'disabled']) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("extra_charge") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text("extra_charge", null, ["class" => "form-control","placeholder"=> trans("order.extra_charge") ,'disabled'=>'disabled']) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("sub_total") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text("sub_total", null, ["class" => "form-control","placeholder"=> trans("order.sub_total") ,'disabled'=>'disabled']) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("total") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text("total", null, ["class" => "form-control","placeholder"=> trans("order.total") ,'disabled'=>'disabled']) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("rate") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text("rate", null, ["class" => "form-control","placeholder"=> trans("order.rate") ,'disabled'=>'disabled']) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("point") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text("point", null, ["class" => "form-control","placeholder"=> trans("order.point"),'disabled'=>'disabled']) !!}
