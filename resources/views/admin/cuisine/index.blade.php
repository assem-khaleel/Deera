...
@endif
        ...
        <div class="right-side-panel">
            <div class="scrollable-right container">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('status', null, ['placeholder'=>trans('cuisine.status'),'class'=>'form-control input-sm ']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('created_at', null, ['placeholder'=>trans('cuisine.created_at'),'class'=>'form-control input-sm ']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('updated_at', null, ['placeholder'=>trans('cuisine.updated_at'),'class'=>'form-control input-sm ']) !!}
