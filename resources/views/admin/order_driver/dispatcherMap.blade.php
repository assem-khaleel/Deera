            ...
            <div multiple id="waypoints">
                ...
                @foreach($oOrderResults as $oOrderResult)
                    ...
                    <label class="oneOrder" >
                        ...
                        <input type="checkbox" id="order_checkbox_{{$oOrderResult->id}}" name="order_id[]" value="{{$oOrderResult->id}}" data-location="{{$oOrderResult->address->lat.','.$oOrderResult->address->long}}"
...
<div id="serviceBoyList" style="display:none;">
    @foreach($serviceBoyList as $serviceBoy)
        <div class="oneShop" id="service_boy_{{$serviceBoy->users_id}}">
