...
<div id="right-panel">
            ...
            <div id="DriverList">
                ...
                @foreach($oShopUsers as &$oShopUser)
                    ...
                    <label class="oneDriver">
                        <input type="radio" style="display: none" name="users_id" id="driver_radio_{{$oShopUser->users_id }}" value="{{$oShopUser->users_id }},{{$current_lat.','.$current_long }}" data-location="{{$current_lat.','.$current_long }}">
 ...
 mobile : {{$oShopUser->users->mobile  }} - phone : {{$oShopUser->users->phone  }}
                         ...
                         <br> number of orders with driver :{{$oShopUser->deliveringOrder}}
                          </div>
                    </label>
                @endforeach
            </div>
