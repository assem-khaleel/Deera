            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('project.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('catering.cateringCreate') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="white-box">
                        ...
                        <p class="text-muted m-b-40">{{ trans('catering.addcatering') }}</p>
                        <!-- Nav tabs -->
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="idetail">
                                ...
                                {!! Form::model($request,['url' => '/admin/catering', 'class' => 'form-horizontal']) !!}
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <span class="panel-title">{{ trans('catering.addcatering') }}</span>
                                    </div>
...
<div class="col-sm-8">
    {!! Form::select("shop_id",$shopList, (!isset($request->shop_id)? 0:null), ["class" => "form-control","placeholder"=> trans("catering.shop_id")]) !!}
...
<div class="col-sm-8">
    ...
    {!! $errors->first("book_time", "<p class='help-block'>:message</p>") !!}
                                        ...
                                        <div class="form-group {{ $errors->has("location") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::select("location",$areaList, null, ["class" => "form-control","placeholder"=> trans("catering.location")]) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("status") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::select("status",config('array.catering_status'), null, ["class" => "form-control","placeholder"=> trans("general.status")]) !!}
...
<div class="col-sm-12">
    ...
    <textarea placeholder="{{trans("catering.request")}}" class="form-control" name="request"></textarea>
