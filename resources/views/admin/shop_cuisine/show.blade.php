...
@section('title', trans('shop_cuisine.shop_cuisine'))
@section('content')
    ...
    <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">{{ trans('general.shop_cuisine') }}</h3>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="idetail">
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <span class="panel-title">{{ trans('shop_cuisine.shop_cuisineInfo') }}</span>
                                        </div>
                                        ...
                                        <div class="panel-body">
                                                ...
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('shop_cuisine.shop_id') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$shop_cuisine['shop_id'] }}</label>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('shop_cuisine.cuisine_id') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$shop_cuisine['cuisine_id'] }}</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-offset-6 col-xs-3">
                                                    ...
                                                    @if($canEdit)
                                                        <a href="/admin/shop_cuisine/{{ $shop_cuisine['id'] }}/edit"
