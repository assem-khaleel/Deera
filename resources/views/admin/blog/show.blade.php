...
@section('content')
    ...
    $canEdit=canAccess('admin.blog.edit');
    $canDestroy=canAccess('admin.blog.destroy');
    ...
    <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">{{ trans('general.blog') }}</h3>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="idetail">
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <span class="panel-title">{{ trans('blog.blogInfo') }}</span>
                                        </div>
                                        ...
                                        <div class="panel-body">
                                                ...
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('blog.users_id') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$blog['users_id'] }}</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$blog['title'] }}</label>
                                                                                        ...
                                                                                        <div class="row">                                            <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('blog.img') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$blog['img'] }}</label>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-xs-offset-6 col-xs-3">
                                                    ...
                                                    @if($canEdit)
                                                        <a href="/admin/blog/{{ $blog['id'] }}/edit"
                                                           class="fa fa-edit btn btn-primary form-control"> {{trans('blog.edit')}}</a>
                                                    @endif
                                                </div>
                                                <div class=" col-xs-3">
                                                    @if($canDestroy)
