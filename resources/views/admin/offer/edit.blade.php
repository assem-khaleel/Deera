                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group {{ $errors->has("shop_id") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::select("shop_id",$shopList, $offer->shop_id, ["class" => "form-control mainSelect","data-target"=>"select[name=coffee_id]","placeholder"=> trans("coffee.shop_id")]) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("coffee_id") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::select("coffee_id",$coffeeList, null, ["class" => "form-control","placeholder"=> trans("offer.coffee_id")]) !!}
...
<div class="col-sm-8">
    {!! Form::text("img", null, ["class" => " uploadFile form-control","placeholder"=> trans("offer.img")]) !!}
