            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('project.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('shop.shopCreate') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="white-box">
                        ...
                        <p class="text-muted m-b-40">{{ trans('shop.addshop') }}</p>
                        <!-- Nav tabs -->
...
$request->merge(['deliver_time_from'=>$current_time,'deliver_time_to'=>$current_time,'working_hour_from'=>$current_time,'working_hour_to'=>$current_time]);
                        ...
                        /*--}}
                        {!! Form::model($request,['url' => '/admin/shop', 'class' => 'form-horizontal']) !!}
                            ...
                            <div role="tabpanel" class="tab-pane active" id="idetail">
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group {{ $errors->has("branch") ? "has-error" : ""}}  col-xs-6" style="display: none;">
 ...
 -->
                                            <div class="col-sm-8">  
                                               {!! Form::select("available_payment",["kent"=>"knet"], null, ["class" => "form-control","placeholder"=> 'Deliver payment']) !!}
                                               </div>
                                        </div>
...
<div class="clearfix"></div>
                                        ...
                                        <div class="form-group {{ $errors->has("rating") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::select("rating",config('array.rate'), null, ["class" => "form-control","placeholder"=> trans("shop.rating")]) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("show_menu") ? "has-error" : ""}}  col-xs-6" style="display:none;">
                                            {!! Form::label("show_menu", trans("shop.show_menu"), ["class" => "col-sm-4 control-label"]) !!}
                                            <div class="col-sm-8">
                                                {!! Form::text("show_menu",(!isset($request->show_menu)? 1:null) , ["class" => "form-control","placeholder"=> trans("shop.show_menu")]) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("order_accept_days") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text("order_accept_days",(!isset($request->order_accept_days)? 365: null), ["class" => "form-control","placeholder"=> trans("shop.order_accept_days")]) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("discount") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text("discount", null, ["class" => "form-control","placeholder"=> 0]) !!}
