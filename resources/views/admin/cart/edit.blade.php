                            ...
                            <div role="tabpanel" class="tab-pane active" id="idetail">
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group {{ $errors->has("size_id") ? "has-error" : ""}}  col-xs-6">
                                            {!! Form::label("size", trans("cart.size"), ["class" => "col-sm-4 control-label"]) !!}
                                            <div class="col-sm-8">
                                                {!! Form::select("size_id",$sizeList, null, ["class" => "form-control","placeholder"=> trans("cart.size")]) !!}
