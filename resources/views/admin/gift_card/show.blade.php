...
@section('title', trans('gift_card.gift_card'))
@section('content')
    ...
    $canGiftCardUsersRelation=canAccess('admin.gift_card_users.relation');
    $canGiftCardUsersEdit=canAccess('admin.gift_card_users.edit');
    $canGiftCardUsersDestroy=canAccess('admin.gift_card_users.destroy');
    $canGiftCardUsersCreate=canAccess('admin.gift_card_users.create');
    $canGiftCardUsersShow=canAccess('admin.gift_card_users.show');

    $canGiftCardOrderRelation=canAccess('admin.gift_card_order.relation');
    $canGiftCardOrderEdit=canAccess('admin.gift_card_order.edit');
    $canGiftCardOrderDestroy=canAccess('admin.gift_card_order.destroy');
    $canGiftCardOrderCreate=canAccess('admin.gift_card_order.create');
    $canGiftCardOrderShow=canAccess('admin.gift_card_order.show');
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-offset-6 col-xs-3">
                                                    ...
                                                    @if($canEdit)
                                                        <a href="/admin/gift_card/{{ $gift_card['id'] }}/edit"
                                                ...
                                                'url' => ['/admin/gift_card',$gift_card['id']]]) !!}
                                            ...
                                            <div class="col-lg-12">
                                                <div class="white-box">
                                                    ...
                                                    @if( $canGiftCardUsersCreate)
                                                        <div class="col-xs-3">
                                                            <a  href="{{route('admin.gift_card_users.create')}}?gift_card_id={{$gift_card['id'] }}"class="btn btn-primary form-control">
                                                                        ...
                                                                        <div class="tableActionsMenuDiv">
                                                                            <div class="innerContainer">
                                                                                ...
                                                                                @if($canGiftCardUsersDestroy )
                                                                                    {!! Form::open(['method' => 'DELETE',
                                                                                    'url' => ['/admin/gift_card_users',$oResult->id]]) !!}
                                                                                ...
                                                                                @if( $canGiftCardUsersEdit)
                                                                                    <a href="/admin/gift_card_users/{{ $oResult->id }}/edit"
                                                                                       class="fa fa-edit"></a>
                                                                                @endif
                                                                                @if($canGiftCardUsersShow )
                                                                                    <a href="/admin/gift_card_users/{{ $oResult->id }}"
                                            ...
                                            <div class="col-lg-12">
                                                <div class="white-box">
                                                    ...
                                                    @if( $canGiftCardOrderCreate)
                                                        <div class="col-xs-3">
                                                            <a  href="{{route('admin.gift_card_order.create')}}?gift_card_id={{$gift_card['id'] }}"class="btn btn-primary form-control">
                                                                        ...
                                                                        <div class="tableActionsMenuDiv">
                                                                            <div class="innerContainer">
                                                                                ...
                                                                                @if($canGiftCardOrderDestroy )
                                                                                    {!! Form::open(['method' => 'DELETE',
                                                                                    'url' => ['/admin/gift_card_order',$oResult->id]]) !!}
                                                                                    <button type="submit" name="Delete" class="deleteRow" >
                                                                                        <i class="fa fa-trash"></i>
                                                                                    </button>
                                                                                    {!! Form::close() !!}
                                                                                ...
                                                                                @if( $canGiftCardOrderEdit)
                                                                                    <a href="/admin/gift_card_order/{{ $oResult->id }}/edit"
                                                                                       class="fa fa-edit"></a>
                                                                                @endif
                                                                                @if($canGiftCardOrderShow )
                                                                                    <a href="/admin/gift_card_order/{{ $oResult->id }}"
                                                                                       class="fa fa-file-text"></a>
