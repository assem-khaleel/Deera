...
@section('content')
    ...
    $canShow=canAccess('website.knet.show');
    $canEdit=canAccess('website.knet.edit');
    $canDestroy=canAccess('website.knet.destroy');
    $canCreate=canAccess('website.knet.create');
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        @if($canCreate)
                        <div class="col-xs-3">
                            <a  href="{{route('website.knet.create')}}"class="btn btn-primary form-control">
...
@endif
                                                        @if($canEdit )
                                            <a href="/website/knet/{{ $oResult->id }}/edit"
                                               class="fa fa-edit"></a>
@endif
                                                            @if($canShow)
                                                    <a href="/website/knet/{{ $oResult->id }}"
