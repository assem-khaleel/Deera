...
@section('title', trans('payment_way.payment_way').'  '.trans('website.pages_title'))
@section('content')
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$payment_way['payment_way_id'] }}</label>
                                                                                        ...
                                                                                        <div class="row">                                            <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('payment_way.setting') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$payment_way['setting'] }}</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-offset-6 col-xs-3">
                                                    ...
                                                    @if($canEdit)
                                                        <a href="/website/payment_way/{{ $payment_way['id'] }}/edit"
