                    ...
                    <div class="white-box">
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="idetail">
                                ...
                                {!! Form::model($request,['url' => '/website/payment_way', 'class' => 'form-horizontal']) !!}
...
<div class="col-sm-8">
    {!! Form::text("shop_id", null, ["class" => "form-control","placeholder"=> trans("payment_way.shop_id")]) !!}
...
<div class="col-sm-8">
    {!! Form::text("payment_way_id", null, ["class" => "form-control","placeholder"=> trans("payment_way.payment_way_id")]) !!}
    {!! $errors->first("payment_way_id", "<p class='help-block'>:message</p>") !!}
        ...
        <div class="form-group {{ $errors->has("setting") ? "has-error" : ""}}  col-xs-12">
{!! Form::label("setting", trans("payment_way.setting"), ["class" => "col-sm-12"]) !!}
<div class="col-sm-12">
    {!! Form::textarea("setting", null, ["class" => "form-control","placeholder"=> trans("payment_way.setting")]) !!}
