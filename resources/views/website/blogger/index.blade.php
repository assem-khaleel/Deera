            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        @if($canCreate)
                        <div class="col-xs-3">
                            <a  href="{{route('website.blogger.create')}}"class="btn btn-primary form-control">
                                        ...
                                        <td>
                                            ...
                                            <div class="tableActionsMenuDiv">
                                                <div class="innerContainer">
                                                    ...
                                                    'url' => ['/website/blogger',$oResult->id]]) !!}
...
@endif
                                                        @if($canEdit )
                                            <a href="/website/blogger/{{ $oResult->id }}/edit"
                                               class="fa fa-edit"></a>
@endif
                                                            @if($canShow)
                                                    <a href="/website/blogger/{{ $oResult->id }}"
...
@endif
        ...
        <div class="right-side-panel">
            <div class="scrollable-right container">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('status', null, ['placeholder'=>trans('blogger.status'),'class'=>'form-control input-sm ']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('created_at', null, ['placeholder'=>trans('blogger.created_at'),'class'=>'form-control input-sm ']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('updated_at', null, ['placeholder'=>trans('blogger.updated_at'),'class'=>'form-control input-sm ']) !!}
