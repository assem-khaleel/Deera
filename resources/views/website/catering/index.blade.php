            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        @if($canCreate)
                        <div class="col-xs-3">
                            <a  href="{{route('website.catering.create')}}" class="btn btn-primary form-control">
                        ...
                        <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                            ...
                            <tr>
                                        ...
                                        {!! th_sort(trans('catering.shop_id'), 'shop_id', $oResults) !!}
                                    </th>

                                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="6">
                                        {!! th_sort(trans('catering.people_number'), 'people_number', $oResults) !!}
                                    </th>
                                        ...
                                        {!! th_sort(trans('catering.request'), 'request', $oResults) !!}
                                    </th>
                                        ...
                                        <td>
                                            ...
                                            <div class="tableActionsMenuDiv">
                                                <div class="innerContainer">
                                                    ...
                                                    'url' => ['/website/catering',$oResult->id]]) !!}
...
@endif
                                                        @if($canEdit )
                                            <a href="/website/catering/{{ $oResult->id }}/edit"
                                               class="fa fa-edit"></a>
@endif
                                                            @if($canShow)
                                                    <a href="/website/catering/{{ $oResult->id }}"
...
@endif
        ...
        <div class="right-side-panel">
            <div class="scrollable-right container">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('shop_id', null, ['placeholder'=>trans('catering.shop_id'),'class'=>'form-control input-sm ']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('request', null, ['placeholder'=>trans('catering.request'),'class'=>'form-control input-sm ']) !!}
