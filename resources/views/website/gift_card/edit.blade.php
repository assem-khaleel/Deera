...
@section('title', trans('general.gift_card').'  '.trans('website.pages_title'))
@section('content')
            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('project.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('gift_card.editgift_card') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="white-box">
                        ...
                        <p class="text-muted m-b-40">{{ trans('gift_card.editgift_card') }}</p>
                        <!-- Nav tabs -->
                            ...
                            <div role="tabpanel" class="tab-pane active" id="idetail">
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <span class="panel-title">{{ trans('gift_card.editgift_card') }}</span>
                                    </div>
...
<div class="col-sm-8">
    {!! Form::text("img", null, ["class" => "form-control","placeholder"=> trans("gift_card.img")]) !!}
...
{!! Form::label("discount", trans("gift_card.discount"), ["class" => "col-sm-4 control-label"]) !!}
<div class="col-sm-8">
    {!! Form::text("discount", null, ["class" => "form-control","placeholder"=> trans("gift_card.discount")]) !!}
