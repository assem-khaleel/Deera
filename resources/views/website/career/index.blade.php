...
@section('content')
    ...
    $canShow=canAccess('website.career.show');
    $canEdit=canAccess('website.career.edit');
    $canDestroy=canAccess('website.career.destroy');
    $canCreate=canAccess('website.career.create');
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        @if($canCreate)
                        <div class="col-xs-3">
                            <a  href="{{route('website.career.create')}}" class="btn btn-primary form-control">
...
@endif
                                                        @if($canEdit )
                                            <a href="/website/career/{{ $oResult->id }}/edit"
                                               class="fa fa-edit"></a>
@endif
                                                            @if($canShow)
                                                    <a href="/website/career/{{ $oResult->id }}"
