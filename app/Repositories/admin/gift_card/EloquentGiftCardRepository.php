<?php
namespace App\Repositories\admin\gift_card;

use Session;
use App\Models\GiftCard;
use App\Repositories\admin\gift_card\GiftCardContract;
...
if(canAccess('admin.gift_card.allData')) {

}elseif(canAccess('admin.gift_card.groupData')){
$oResults = $oResults->where('users_id','=',  current_user()->getUser()->id);
}elseif(canAccess('admin.gift_card.userData')){
