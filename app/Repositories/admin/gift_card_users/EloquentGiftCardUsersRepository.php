<?php
namespace App\Repositories\admin\gift_card_users;

use Session;
use App\Models\GiftCardUsers;
use App\Repositories\admin\gift_card_users\GiftCardUsersContract;
...
if(canAccess('admin.gift_card_users.allData')) {

}elseif(canAccess('admin.gift_card_users.groupData')){
$oResults = $oResults->where('users_id','=',  current_user()->getUser()->id);
}elseif(canAccess('admin.gift_card_users.userData')){
