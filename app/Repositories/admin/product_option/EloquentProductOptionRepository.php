<?php
namespace App\Repositories\admin\product_option;

use Session;
use App\Models\ProductOption;
use App\Repositories\admin\product_option\ProductOptionContract;
...
if(canAccess('admin.product_option.allData')) {

}elseif(canAccess('admin.product_option.groupData')){
//$oResults = $oResults->where('users_id','=',  current_user()->getUser()->id);
}elseif(canAccess('admin.product_option.userData')){
