...
Route::get('website/logout', [
    'as' => 'client.auth.logout',
    'uses' => 'common\authentication\AuthController@getWebsiteLogout'
]);
...
Route::get('admin-recover', [
    'before'=>'changeLanguage',
    'as' => 'client.auth.recover',
    'uses' => 'common\authentication\AuthController@getAdminRecover'
]);
Route::post('admin-recover', [
    'as' => 'client.auth.recover',
    'uses' => 'common\authentication\AuthController@postAdminRecover'
]);
