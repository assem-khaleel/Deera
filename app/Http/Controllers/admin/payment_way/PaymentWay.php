...
class PaymentWay extends Controller
{
    ...
    public function index(Request $request,rShop $rShop)
    {
        ...
        return view('admin.payment_way.index', compact('oResults','request','statistic','shopList'));
    }
...
$shopList=$rShop->getAllList();
        ...
        return view('admin.payment_way.create',compact('request','shopList'));
    }
 ...
 $shopList=$rShop->getAllList();
        return view('admin.payment_way.edit', compact('payment_way','shopList'));
    }
