...
$governorateList=$rGovernorate->getAllList();
     ...
     * @return view
     */
    public function show($id,Request $request,rShop $rShop,rShopArea $rShopArea,rAddress $rAddress)
    {
    ...
    $oAddressResults=$rAddress->getByFilter($request);
        ...
        return view('admin.area.show', compact('area','request','oShopResults','oShopAreaResults','oAddressResults'));
    }
