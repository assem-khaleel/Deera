...
namespace App\Http\Controllers\admin\gift_card;
...
use App\Http\Requests\admin\gift_card\createRequest;
use App\Http\Requests\admin\gift_card\editRequest;
use Session;
...
class GiftCard extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.gift_card.index', compact('oResults','request','statistic'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.gift_card.create',compact('request'));
    }
    ...
    public function store(createRequest $request)
    {
        ...
        return redirect('admin/gift_card');
    }
    ...
    $oGiftCardOrderResults=$rGiftCardOrder->getByFilter($request);
        ...
        return view('admin.gift_card.show', compact('gift_card','request','oGiftCardUsersResults','oGiftCardOrderResults'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.gift_card.edit', compact('gift_card'));
    }
