...
class FilesController extends Controller
{
    ...
    public function postUploadInput($fieldName,$destination,$allowedFiles)
    {


        $file = Input::file($fieldName);
        if(!$file){return 'please add file.';}
        $allowed_ext = $allowedFiles;
        ...
        if (in_array($fileExt, $allowed_ext) ) {
            ...
            if ($file->move( $destination, $imageName)) {
                ...
                return ['status'=>'success','file'=>$destination.'/'.$imageName] ;
            }//uploaded successfully
            else {
                return 'error, not uploaded ...';
            }//error uploaded
