...
namespace App\Http\Controllers\website\gift_card_order;
...
use App\Http\Requests\website\gift_card_order\createRequest;
use App\Http\Requests\website\gift_card_order\editRequest;
use Session;
...
class GiftCardOrder extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('website.gift_card_order.index', compact('oResults','request','statistic'));
    }
...
$giftCardList=$rGiftCard->getAllList();
        ...
        return view('website.gift_card_order.create',compact('request','orderList','giftCardList'));
    }
    ...
    public function store(createRequest $request)
    {
        ...
        return redirect('website/gift_card_order');
    }
    ...
    public function show($id,Request $request)
    {
      ...
      $request->merge(['gift_card_order_id'=>$id,'page_name'=>'page']);
        ...
        return view('website.gift_card_order.show', compact('gift_card_order','request'));
    }
 ...
 $orderList=$rOrder->getAllList();
 $giftCardList=$rGiftCard->getAllList();
        return view('website.gift_card_order.edit', compact('gift_card_order','orderList','giftCardList'));
    }
